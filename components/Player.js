function Player(color, input) {
	...
	this.animations = {
		run: {
			legRear: {
				r: [
					[{x:-3.9041, y:1.3913}, {x:0.0000, y:1.3913}, {x:3.9041, y:1.3913}],
					[{x:6.0959, y:1.2558}, {x:10.0000, y:1.1146}, {x:13.9041, y:0.9734}],
					[{x:16.0959, y:0.8509}, {x:20.0000, y:0.6679}, {x:23.9041, y:0.4849}],
					[{x:26.0959, y:0.3531}, {x:30.0000, y:0.1770}, {x:33.9041, y:0.0010}],
					[{x:36.0959, y:-0.2341}, {x:40.0000, y:-0.2341}, {x:43.9041, y:-0.2341}],
					[{x:46.0959, y:-0.0800}, {x:50.0000, y:0.0434}, {x:53.9041, y:0.1669}],
					[{x:56.0959, y:0.2185}, {x:60.0000, y:0.3984}, {x:63.9041, y:0.5783}],
					[{x:66.0959, y:0.7789}, {x:70.0000, y:0.9651}, {x:74.2945, y:1.1700}],
					[{x:76.7055, y:1.3913}, {x:81.0000, y:1.3913}, {x:85.2945, y:1.3913}]
				],
				x: [
					[{x:-3.9041, y:70.0329}, {x:0.0000, y:70.0329}, {x:3.9041, y:70.0329}],
					[{x:6.0959, y:59.1022}, {x:10.0000, y:46.2242}, {x:13.9041, y:33.3463}],
					[{x:16.0959, y:21.5838}, {x:20.0000, y:4.0617}, {x:23.9041, y:-13.4604}],
					[{x:26.0959, y:-25.3763}, {x:30.0000, y:-43.5380}, {x:33.9041, y:-61.6998}],
					[{x:36.0959, y:-88.9774}, {x:40.0000, y:-88.9774}, {x:43.9041, y:-88.9774}],
					[{x:46.0959, y:-88.9774}, {x:50.0000, y:-77.7525}, {x:53.9041, y:-66.5275}],
					[{x:56.0959, y:-7.6807}, {x:60.0000, y:17.3010}, {x:63.9041, y:42.2828}],
					[{x:66.0959, y:40.2820}, {x:70.0000, y:50.2240}, {x:74.2945, y:61.1602}],
					[{x:76.7055, y:70.0329}, {x:81.0000, y:70.0329}, {x:85.2945, y:70.0329}]
				],
				y: [
					[{x:-3.9041, y:-107.4868}, {x:0.0000, y:-107.4868}, {x:3.9041, y:-107.4868}],
					[{x:6.0959, y:-64.1074}, {x:10.0000, y:-64.1074}, {x:13.9041, y:-64.1074}],
					[{x:16.0959, y:-79.1723}, {x:20.0000, y:-79.7682}, {x:23.9041, y:-80.3641}],
					[{x:26.0959, y:-79.7682}, {x:30.0000, y:-80.3641}, {x:33.9041, y:-80.9600}],
					[{x:36.0959, y:-114.1539}, {x:40.0000, y:-114.1539}, {x:43.9041, y:-114.1539}],
					[{x:46.0959, y:-76.7725}, {x:50.0000, y:-52.0306}, {x:53.9041, y:-27.2886}],
					[{x:56.0959, y:-4.1090}, {x:60.0000, y:12.5941}, {x:63.9041, y:29.2971}],
					[{x:66.0959, y:33.5359}, {x:70.0000, y:33.5359}, {x:74.2945, y:33.5359}],
					[{x:76.7055, y:-107.4868}, {x:81.0000, y:-107.4868}, {x:85.2945, y:-107.4868}]
				]
			},
			legFront: {
				r: [
					[{x:-3.9041, y:-1.2054}, {x:0.0000, y:-1.2054}, {x:3.9041, y:-1.2054}],
					[{x:6.0959, y:-0.9274}, {x:10.0000, y:-0.7123}, {x:13.9041, y:-0.4971}],
					[{x:16.0959, y:-0.2945}, {x:20.0000, y:-0.1034}, {x:23.9041, y:0.0876}],
					[{x:26.0959, y:0.2664}, {x:30.0000, y:0.2664}, {x:31.9521, y:0.2664}],
					[{x:33.0479, y:0.2286}, {x:35.0000, y:0.1817}, {x:36.9521, y:0.1349}],
					[{x:38.0479, y:0.0803}, {x:40.0000, y:0.0264}, {x:43.9041, y:-0.0814}],
					[{x:46.0959, y:-0.1083}, {x:50.0000, y:-0.2155}, {x:53.9041, y:-0.3228}],
					[{x:56.0959, y:-0.3855}, {x:60.0000, y:-0.5229}, {x:63.9041, y:-0.6602}],
					[{x:66.0959, y:-0.7910}, {x:70.0000, y:-0.9192}, {x:74.2945, y:-1.0602}],
					[{x:76.7055, y:-1.2054}, {x:81.0000, y:-1.2054}, {x:85.2945, y:-1.2054}],
				],
				x: [
					[{x:-3.9041, y:-65.6461}, {x:0.0000, y:-65.6461}, {x:3.9041, y:-65.6461}],
					[{x:6.0959, y:-65.6461}, {x:10.0000, y:-52.1203}, {x:13.9041, y:-38.5944}],
					[{x:16.0959, y:-18.3810}, {x:20.0000, y:9.9611}, {x:23.9041, y:38.3032}],
					[{x:26.0959, y:68.2933}, {x:30.0000, y:93.0707}, {x:31.9521, y:105.4595}],
					[{x:33.0479, y:114.9809}, {x:35.0000, y:114.9809}, {x:36.9521, y:114.9809}],
					[{x:38.0479, y:76.3716}, {x:40.0000, y:62.3623}, {x:43.9041, y:34.3438}],
					[{x:46.0959, y:37.8592}, {x:50.0000, y:24.0665}, {x:53.9041, y:10.2737}],
					[{x:56.0959, y:5.7127}, {x:60.0000, y:-8.2952}, {x:63.9041, y:-22.3032}],
					[{x:66.0959, y:-36.8166}, {x:70.0000, y:-47.6932}, {x:74.2945, y:-59.6575}],
					[{x:76.7055, y:-65.6461}, {x:81.0000, y:-65.6461}, {x:85.2945, y:-65.6461}],
				],
				y: [
					[{x:-3.9041, y:-129.5896}, {x:0.0000, y:-129.5896}, {x:3.9041, y:-129.5896}],
					[{x:6.0959, y:-85.2552}, {x:10.0000, y:-58.2881}, {x:13.9041, y:-31.3210}],
					[{x:16.0959, y:8.5573}, {x:20.0000, y:8.5573}, {x:23.9041, y:8.5573}],
					[{x:26.0959, y:-24.6137}, {x:30.0000, y:-55.8010}, {x:31.9521, y:-71.3946}],
					[{x:33.0479, y:-103.5048}, {x:35.0000, y:-103.5048}, {x:36.9521, y:-103.5048}],
					[{x:38.0479, y:-93.6316}, {x:40.0000, y:-90.5040}, {x:43.9041, y:-84.2488}],
					[{x:46.0959, y:-84.2488}, {x:50.0000, y:-84.2488}, {x:53.9041, y:-84.2488}],
					[{x:56.0959, y:-93.5667}, {x:60.0000, y:-95.4011}, {x:63.9041, y:-97.2355}],
					[{x:66.0959, y:-95.4011}, {x:70.0000, y:-97.2355}, {x:74.2945, y:-99.2533}],
					[{x:76.7055, y:-129.5896}, {x:81.0000, y:-129.5896}, {x:85.2945, y:-129.5896}],
				]
			},
			armRear: {
				r: [
					[{x:-15.6165, y:-2.5700}, {x:0.0000, y:-2.5700}, {x:15.6165, y:-2.5700}],
					[{x:24.3835, y:-0.1406}, {x:40.0000, y:-0.1406}, {x:56.0069, y:-0.1406}],
					[{x:64.9931, y:-2.5700}, {x:81.0000, y:-2.5700}, {x:97.0069, y:-2.5700}]
				]
			},
			body: {
				r: [
					[{x:-15.6165, y:-0.1797}, {x:0.0000, y:-0.1797}, {x:15.6165, y:-0.1797}],
					[{x:24.3835, y:-0.1506}, {x:40.0000, y:-0.1506}, {x:56.0069, y:-0.1506}],
					[{x:64.9931, y:-0.1797}, {x:81.0000, y:-0.1797}, {x:97.0069, y:-0.1797}]
				],
				x: [
					[{x:-31.6233, y:0.1097}, {x:0.0000, y:0.1097}, {x:31.6233, y:0.1097}],
					[{x:49.3767, y:0.1097}, {x:81.0000, y:0.1097}, {x:112.6233, y:0.1097}]
				],
				y: [
					[{x:-31.6233, y:700.6578}, {x:0.0000, y:700.6578}, {x:31.6233, y:700.6578}],
					[{x:49.3767, y:700.6578}, {x:81.0000, y:700.6578}, {x:112.6233, y:700.6578}]
				]
			},
			armFront: {
				r: [
					[{x:-7.8082, y:2.6622}, {x:0.0000, y:2.6622}, {x:7.8082, y:2.6622}],
					[{x:12.1918, y:2.5405}, {x:20.0000, y:2.0469}, {x:27.8082, y:1.5534}],
					[{x:32.1918, y:0.1339}, {x:40.0000, y:0.1339}, {x:47.8082, y:0.1339}],
					[{x:52.1918, y:0.3234}, {x:60.0000, y:0.7996}, {x:68.1986, y:1.2997}],
					[{x:72.8014, y:2.6622}, {x:81.0000, y:2.6622}, {x:89.1986, y:2.6622}]
				]
			},
			hair: {
				r: [
					[{x:-15.6165, y:-0.0349}, {x:0.0000, y:-0.0349}, {x:15.6165, y:-0.0349}],
					[{x:24.3835, y:0.0000}, {x:40.0000, y:0.0000}, {x:56.0069, y:0.0000}],
					[{x:64.9931, y:-0.0349}, {x:81.0000, y:-0.0349}, {x:97.0069, y:-0.0349}],
				]
			},
			head: {
				r: [
					[{x:-15.6165, y:0.1498}, {x:0.0000, y:0.1498}, {x:15.6165, y:0.1498}],
					[{x:24.3835, y:0.1150}, {x:40.0000, y:0.1150}, {x:56.0069, y:0.1150}],
					[{x:64.9931, y:0.1498}, {x:81.0000, y:0.1498}, {x:97.0069, y:0.1498}]
				]
			},
			duration: 80
		}
...
Player.prototype.draw = function() {
	...
	Draw.pushPose(
		-0.1097051 / 1024 + this.width / 2,
		675 / 1024 - this.height,
		Animation.get(t, anim.body.r, anim.duration)
	);
	{
		Draw.pushPose(
			(Animation.get(t, anim.legFront.x, anim.duration) - 54.6399574) / 1024,
			(Animation.get(t, anim.legFront.y, anim.duration)  + 62.892395 - 40) / 1024,
			Animation.get(t, anim.legFront.r, anim.duration)
		);
		Leg_Front();
		Draw.popPose();
		
		Draw.pushPose(
			(Animation.get(t, anim.legRear.x, anim.duration) + 69.1485214) / 1024,
			(Animation.get(t, anim.legRear.y, anim.duration) + 26.9537964) / 1024,
			Animation.get(t, anim.legRear.r, anim.duration)
		);
		Leg_Rear();
		Draw.popPose();
		
		Draw.pushPose(95.3038101 / 1024, 505.4633179 / 1024, Animation.get(t, anim.armRear.r, anim.duration));
		Arm_Rear();
		Draw.popPose();
		
		Body();
		
		Draw.pushPose(-5.2577 / 1024, 480.1796265 / 1024, Animation.get(t, anim.armFront.r, anim.duration));
		Arm_Front();
		Draw.popPose();
		
		Draw.pushPose(35.2217674 / 1024, 662.5830688 / 1024, Animation.get(t, anim.head.r, anim.duration));
		{
			Draw.pushPose(-101.5951309 / 1024, 629.1499023 / 1024, Animation.get(t, anim.hair.r, anim.duration));
			Hair();
			Draw.popPose();
